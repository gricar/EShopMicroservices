...
new List<Customer>
{
    ...
    Customer.Create(CustomerId.Of(new Guid("189dc8dc-990f-48e0-a37b-e6f2b60b9d7d")), "ayrton", "ayrton@gmail.com")
};
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            var address1 = Address.Of("gabriel", "ricardo", "gabriel@gmail.com", "Av Salinas No:100", "Brazil", "São Paulo", "12242");
            var address2 = Address.Of("ayrton", "senna", "ayrton@gmail.com", "Broadway No:1", "England", "Nottingham", "08050");

            var payment1 = Payment.Of("gabriel", "5555555555554444", "12/28", "355", 1);
            var payment2 = Payment.Of("ayrton", "8885555555554444", "06/30", "222", 2);
